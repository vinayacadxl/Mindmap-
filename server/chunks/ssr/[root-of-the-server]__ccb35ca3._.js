...
const TaskNode = ({ id, data, selected })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("w-64 rounded-lg border-2 shadow-lg transition-all duration-300", "bg-card/80 backdrop-blur-sm", config.borderClass, selected ? 'shadow-primary/40 shadow-2xl' : 'hover:shadow-2xl hover:shadow-primary/20'),
...
function MindMapComponent() {
    ...
    const [isAiDialogOpen, setAiDialogOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleOpenAiDialog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        const prompt = `Here is a list of tasks. Each task has an ID and a title.\n\n${nodes.map((node)=>`- ID: ${node.id}, Title: ${node.data.title}, Description: ${node.data.description}`).join('\n')}\n\nPlease suggest logical connections (dependencies, workflows) between these tasks. The source and target should be the task IDs.`;
        setAiPrompt(prompt);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ccb35ca3._.js.map