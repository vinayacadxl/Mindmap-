...
const TaskNode = ({ id, data, selected })=>{
    _s();
    const { title, description, status, onUpdateNode } = data;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-64 rounded-lg border-2 shadow-lg transition-all duration-300", "bg-card/80 backdrop-blur-sm", config.borderClass, selected ? 'shadow-primary/40 shadow-2xl' : 'hover:shadow-2xl hover:shadow-primary/20'),
...
function MindMapComponent() {
    ...
    const onNodesChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MindMapComponent.useCallback[onNodesChange]": (changes)=>{
            ...
            setNodes(newNodes);
            if (changes.some({
                "MindMapComponent.useCallback[onNodesChange]": (c)=>c.type === 'remove'
    ...
    const handleOpenAiDialog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MindMapComponent.useCallback[handleOpenAiDialog]": ()=>{
            const prompt = `Here is a list of tasks. Each task has an ID and a title.\n\n${nodes.map({
                "MindMapComponent.useCallback[handleOpenAiDialog]": (node)=>`- ID: ${node.id}, Title: ${node.data.title}, Description: ${node.data.description}`
            }["MindMapComponent.useCallback[handleOpenAiDialog]"]).join('\n')}\n\nPlease suggest logical connections (dependencies, workflows) between these tasks. The source and target should be the task IDs.`;
            setAiPrompt(prompt);
...
_s(MindMapComponent, "6b8CO/mbMBWIDOcC1RLnTtg3DRk=", false, function() {
    return [
...
//# sourceMappingURL=src_91f1b83d._.js.map