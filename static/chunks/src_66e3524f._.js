...
const TaskNode = ({ id, data })=>{
    ...
    const handleInputChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TaskNode.useCallback[handleInputChange]": (field, value)=>{
            onUpdateNode(id, {
                [field]: value
            });
        }
    }["TaskNode.useCallback[handleInputChange]"], [
        id,
        onUpdateNode
    ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-64 rounded-lg border-2 shadow-lg transition-all duration-300", "bg-card/80 backdrop-blur-sm", config.borderClass, "hover:shadow-2xl hover:shadow-primary/20"),
        children: [
...
_s(TaskNode, "a9iFCXacupIH1lmphj1h1U48TAM=");
_c = TaskNode;
...
function MindMap() {
    ...
    const onUpdateNode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MindMap.useCallback[onUpdateNode]": (id, data)=>{
            setNodes({
                "MindMap.useCallback[onUpdateNode]": (nds)=>nds.map({
                        "MindMap.useCallback[onUpdateNode]": (node)=>{
                            if (node.id === id) {
                                return {
                                    ...node,
                                    data: {
                    ...
                    }["MindMap.useCallback[onUpdateNode]"])
            }["MindMap.useCallback[onUpdateNode]"]);
        }
    }["MindMap.useCallback[onUpdateNode]"], [
        setNodes
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "MindMap.useEffect": ()=>{
            const nodesWithCallback = initialNodes.map({
                "MindMap.useEffect.nodesWithCallback": (node)=>({
                        ...node,
                        data: {
                            ...node.data,
                            onUpdateNode
            ...
            }["MindMap.useEffect.nodesWithCallback"]);
    ...
    const onConnect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MindMap.useCallback[onConnect]": (params)=>setEdges({
                "MindMap.useCallback[onConnect]": (eds)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reactflow$2f$core$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addEdge"])(params, eds)
            }["MindMap.useCallback[onConnect]"])
    }["MindMap.useCallback[onConnect]"], [
        setEdges
    ]);
    const handleAddTask = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MindMap.useCallback[handleAddTask]": ()=>{
            ...
            setNodes({
                "MindMap.useCallback[handleAddTask]": (nds)=>nds.concat(newNode)
            }["MindMap.useCallback[handleAddTask]"]);
        }
    }["MindMap.useCallback[handleAddTask]"], [
        setNodes,
    ...
    const handleOpenAiDialog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MindMap.useCallback[handleOpenAiDialog]": ()=>{
            const prompt = `Here is a list of tasks. Each task has an ID and a title.\n\n${nodes.map({
                "MindMap.useCallback[handleOpenAiDialog]": (node)=>`- ID: ${node.id}, Title: ${node.data.title}, Description: ${node.data.description}`
            }["MindMap.useCallback[handleOpenAiDialog]"]).join('\n')}\n\nPlease suggest logical connections (dependencies, workflows) between these tasks. The source and target should be the task IDs.`;
            setAiPrompt(prompt);
    ...
    const handleSuggestConnections = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MindMap.useCallback[handleSuggestConnections]": async ()=>{
            setIsLoading(true);
            try {
                ...
                const newEdges = result.connections.map({
                    "MindMap.useCallback[handleSuggestConnections].newEdges": (conn)=>({
                            id: `e-${conn.source}-${conn.target}-${crypto.randomUUID()}`,
                            source: conn.source,
                            target: conn.target,
                            label: conn.label
                        })
                }["MindMap.useCallback[handleSuggestConnections].newEdges"]);
                const existingEdgeSet = new Set(edges.map({
                    "MindMap.useCallback[handleSuggestConnections]": (e)=>`${e.source}-${e.target}`
                }["MindMap.useCallback[handleSuggestConnections]"]));
                const filteredNewEdges = newEdges.filter({
                    "MindMap.useCallback[handleSuggestConnections].filteredNewEdges": (ne)=>!existingEdgeSet.has(`${ne.source}-${ne.target}`)
                }["MindMap.useCallback[handleSuggestConnections].filteredNewEdges"]);
                ...
                setEdges({
                    "MindMap.useCallback[handleSuggestConnections]": (eds)=>eds.concat(filteredNewEdges)
                }["MindMap.useCallback[handleSuggestConnections]"]);
...
_s(MindMap, "mpDm8YrfNyTzidlr5sUlKP4IBAM=", false, function() {
    return [
...
_c = MindMap;
var _c;
__turbopack_context__.k.register(_c, "MindMap");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_66e3524f._.js.map