...
function MindMapComponent() {
    ...
    const [isAiDialogOpen, setAiDialogOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const handleOpenAiDialog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MindMapComponent.useCallback[handleOpenAiDialog]": ()=>{
            const prompt = `Here is a list of tasks and titles. Each item has an ID and content.\n\n${nodes.map({
                "MindMapComponent.useCallback[handleOpenAiDialog]": (node)=>{
                    if (node.type === 'task') {
...
_s(MindMapComponent, "QHWPHjdQyB0Th38RogGLjqJd6vc=", false, function() {
    return [
...
//# sourceMappingURL=src_2e6804cc._.js.map